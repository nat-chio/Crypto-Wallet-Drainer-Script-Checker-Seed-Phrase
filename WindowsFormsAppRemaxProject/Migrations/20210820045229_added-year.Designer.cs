...
namespace SpotifyCache.Migrations
{
    ...
    [Migration("20210820045229_added-year")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpotifyCache.Analytics.CreationHistory", b =>
                {
                    ...
                    b.ToTable("CreationHistories");
                });

            modelBuilder.Entity("SpotifyCache.Analytics.PercentileBucket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PercentileBuckets");
                });

            modelBuilder.Entity("SpotifyCache.Analytics.PlayerEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SpotifyCache.Domain.Artist", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime?>("LastSearchedSongs")
                        .HasColumnType("datetime2");

                    b.Property<bool>("SearchedRelatedArtists")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SpotifyCache.Domain.Tracks.Track", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("SpotifyCache.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("SpotifyCache.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SpotifyCache.Analytics.CreationHistory", b =>
                {
                    b.HasOne("SpotifyCache.Domain.Tracks.Track", "Track")
                        .WithMany()
